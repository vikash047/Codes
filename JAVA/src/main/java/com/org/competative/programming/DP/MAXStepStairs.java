...
public class MAXStepStairs {
    public static void main(String[] args) {
        InputStream input = System.in;
        OutputStream output = System.out;
        LIS.InputReader in = new LIS.InputReader(input);
        LIS.OutPutWritter out = new LIS.OutPutWritter(output);
        LIS.Solve solve = new LIS.Solve();
        solve.solve(in, out);
        out.close();
    }
    static class Solve {
        public void solve(LIS.InputReader in, LIS.OutPutWritter out) {
            int n = in.readInt();
            int[] a = new int[n];
